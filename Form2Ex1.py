...
# Parameter dictionaries (provided values)
q     = {0: 20, 1: 30}          # Minimum production for plant i
Q     = {0: 100, 1: 120}         # Maximum production for plant i
L     = {0: 3, 1: 2}             # Minimum up time for plant i
l     = {0: 2, 1: 2}             # Minimum down time for plant i
c_SU  = {0: 100, 1: 120}         # Cost of turning on plant i
c_NL  = {0: 50, 1: 60}           # Fixed operating cost for plant i
c_var = {0: 10, 1: 12}           # Variable production cost for plant i
U1    = {0: 3, 1: 0}             # Periods plant i has been on at t=1
U0    = {0: 0, 1: 2}             # Periods plant i has been off at t=1

# Demand for each time period
d = {1: 200, 2: 90, 3: 90, 4: 90, 5: 140}
